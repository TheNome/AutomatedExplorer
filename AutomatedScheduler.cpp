/*Precinct Automated Scheduler.
  The basic idead of this program is to automatically run at computer startup, schedule a shutdown of the PC during a time when the store is closed and open up
  the precinct scheduler client facing page at startup.
  Author: Agent Nick Patterson ARA Badge Number 113845
...
int main()
{
	...
	string websiteLink = "http://reddit.com/";
